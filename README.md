...
```
 Cell ratio, β ={ (W\L) of pull down transistor(NMOS) } / {(W\L)n of access transistor(NMOS) } 
```
...
```
 Pull Up ratio, PR ={ (W\L) of pull up transistor(NMOS) } / {(W\L)n of access transistor(NMOS) } 
```
